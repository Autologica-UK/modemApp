...
public class SmsReceiverAdapter extends RecyclerView.Adapter<SmsReceiverAdapter.MyViewHolder> {

  private final Context context;
  private final LayoutInflater mInflater;
  private List<Sms> smsList;

  public SmsReceiverAdapter(Context context, List<Sms> smsList) {
  ...
  public MyViewHolder onCreateViewHolder(ViewGroup parent, int i) {
    View view = mInflater.inflate(R.layout.list_item_received, parent, false);
